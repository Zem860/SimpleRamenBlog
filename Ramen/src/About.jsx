const About = () => {
  return (
    <div className="container text-center">
      ...
      <div className="row">
        <p className="text-start" style={{"text-indent": "2em"}}> 拉麵是一道在日本深受喜愛的料理，其濃郁的湯頭、彈牙的麵條和豐富的配料組成了獨特的美食體驗。在動漫《火影忍者》中，主角鳴人最愛的就是一樂拉麵，這家拉麵店不僅是鳴人和朋友們聚會的地方，也是許多粉絲心中的經典場景。而在《數碼寶貝02》中，大輔則夢想著長大後能開一家拉麵店，他對拉麵充滿熱情，每當冒險之餘，他總幻想著自己未來經營著一間充滿笑聲和美味的拉麵店，帶給人們像拉麵湯頭般溫暖的感受。這些動漫中的場景展現了拉麵作為日本文化的一部分，帶給人們滿足與能量。</p>
        <p className="text-start" style={{"text-indent": "2em"}}>Ramen is a dish deeply loved in Japan, with its rich broth,
              ...
              of Japanese culture, brings people satisfaction and energy.</p>
      </div>
    </div>
  );
};
